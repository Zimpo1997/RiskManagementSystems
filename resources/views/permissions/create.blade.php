                ...
                <div class="col-md-6 col-sm-12 ">
                    <nav aria-label="breadcrumb" role="navigation" class="float-right">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ URL::to('/roles') }}">จัดการข้ออนุญาต</a></li>
                            <li class="breadcrumb-item active" aria-current="page">เพิ่มข้ออนุญาต</li>
                        </ol>
                    </nav>
                </div>
        ...
        <div class="pd-20 card-box mb-30">
            <div class="mb-5">
                <div class="text-center">
                    <h4 class="text-blue h4">เพิ่มข้ออนุญาต</h4>
                </div>
            </div>
